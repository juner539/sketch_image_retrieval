...
class _equalized_conv2d(th.nn.Module):
    ...
    def __init__(self, c_in, c_out, k_size, stride=1, padding=0, bias=True):
...
class DisFinalBlock(th.nn.Module):
    ...
    def __init__(self, in_channels, use_eql):
        ...
        if use_eql:
            self.conv_1 = _equalized_conv2d(in_channels + 1, in_channels, (3, 3), padding=1, bias=True)
...
class DisGeneralConvBlock(th.nn.Module):
    ...
    def __init__(self, in_channels, out_channels, use_eql):
        ...
        if use_eql:
            self.conv_1 = _equalized_conv2d(in_channels, in_channels, (3, 3), padding=1, bias=True)
            self.conv_2 = _equalized_conv2d(in_channels, out_channels, (3, 3), padding=1, bias=True)
        else:
            from torch.nn import Conv2d
